...
## 15. Pagina estatica de semaforos con Dijkstra

El repositorio tambien incluye una pagina HTML autonoma para mostrar una simulacion de control de semaforos con prioridad calculada por Dijkstra.

Para abrirla localmente, usa `index.html` o `grafo2_para_compartir.html` con un navegador moderno.

Para publicarla con GitHub Pages, activa Pages desde `Settings > Pages` y selecciona la rama `main` desde la raiz del repositorio.
